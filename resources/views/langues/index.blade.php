    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 space-y-4 sm:space-y-0">
            <div>
                ...
                <p class="text-gray-600 mt-2">Liste de toutes les langues disponibles</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-200 p-6 transform hover:scale-105 transition-transform duration-300">
                ...
                <div class="space-y-4">
                    <div class="flex justify-between items-center p-3 bg-primary-50 rounded-lg">
                        <span class="text-sm font-medium text-gray-700">Total des langues:</span>
                        <span class="font-bold text-primary-600 text-lg">{{ $langues->count() }}</span>
                    </div>
                    <div class="flex justify-between items-center p-3 bg-amber-50 rounded-lg">
                        <span class="text-sm font-medium text-gray-700">Dernier ajout:</span>
                        <span class="text-sm font-semibold text-amber-600">
                            {{ $langues->last() ? \Carbon\Carbon::parse($langues->last()->created_at)->diffForHumans() : 'N/A' }}
                        </span>
                    </div>
                </div>
            </div>
                    ...
                    <a href="{{ route('langues.create') }}" 
                       class="flex items-center justify-between p-3 bg-gradient-to-r from-primary-50 to-blue-50 rounded-lg hover:from-primary-100 hover:to-blue-100 transition-all duration-200 group">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm font-medium text-gray-700 group-hover:text-gray-900">Ajouter une langue</span>
                        </div>
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-200 p-6 transform hover:scale-105 transition-transform duration-300">
                ...
                <p class="text-sm text-gray-600 mb-4 leading-relaxed">
                    Gérez facilement vos langues avec les actions disponibles. Utilisez les boutons pour voir, modifier ou supprimer les langues.
                </p>
