    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 space-y-4 sm:space-y-0">
            <div>
                ...
                <p class="text-gray-600 mt-2">Liste de tous les commentaires</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-200 p-6 transform hover:scale-105 transition-transform duration-300">
                ...
                <div class="space-y-4">
                    <div class="flex justify-between items-center p-3 bg-primary-50 rounded-lg">
                        <span class="text-sm font-medium text-gray-700">Total des commentaires:</span>
                        <span class="font-bold text-primary-600 text-lg">{{ $commentaires->count() }}</span>
                    </div>
                    <div class="flex justify-between items-center p-3 bg-amber-50 rounded-lg">
                        <span class="text-sm font-medium text-gray-700">Note moyenne:</span>
                        <span class="text-sm font-semibold text-amber-600">
                            {{ number_format($commentaires->avg('note'), 1) }}/5
                        </span>
                    </div>
                </div>
            </div>
                    ...
                    <a href="{{ route('commentaires.create') }}" 
                       class="flex items-center justify-between p-3 bg-gradient-to-r from-primary-50 to-blue-50 rounded-lg hover:from-primary-100 hover:to-blue-100 transition-all duration-200 group">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm font-medium text-gray-700 group-hover:text-gray-900">Ajouter un commentaire</span>
                        </div>
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-200 p-6 transform hover:scale-105 transition-transform duration-300">
                ...
                <p class="text-sm text-gray-600 mb-4 leading-relaxed">
                    Gérez facilement vos commentaires avec les actions disponibles. Utilisez les boutons pour voir, modifier ou supprimer les commentaires.
                </p>
                            ...
                            <tr class="hover:bg-gray-50 transition-all duration-200 group">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex items-center text-amber-500">
                                            @for($i = 1; $i <= 5; $i++)
                                                <i class="fas fa-star{{ $i <= $commentaire->note ? '' : '-half-alt' }} text-sm mr-0.5"></i>
                                            @endfor
                                        </div>
                                        <span class="ml-2 text-sm font-medium text-gray-900 bg-amber-100 px-2 py-1 rounded">
                                            {{ $commentaire->note }}/5
                                        </span>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">
                                        {{ \Carbon\Carbon::parse($commentaire->date)->format('d/m/Y') }}
                                    </div>
                                    <div class="text-xs text-gray-500">
                                        {{ \Carbon\Carbon::parse($commentaire->date)->format('H:i') }}
                                    </div>
                                </td>
