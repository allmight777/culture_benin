...
<div class="flex justify-between items-center mb-6">
  <h1 class="text-2xl font-bold text-gray-800">Créer un nouveau contenu</h1>
    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
      ...
      <li aria-current="page">
        <div class="flex items-center">
          ...
          <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Nouveau contenu</span>
        </div>
      </li>
    </ol>
  </nav>
  ...
  <div class="bg-white shadow-md rounded-lg overflow-hidden border border-gray-200">
    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b border-gray-200">
      <div class="flex items-center">
        ...
        <div>
          <h2 class="text-xl font-semibold text-gray-800">Informations du nouveau contenu</h2>
          <p class="text-sm text-gray-600 mt-1">Remplissez les détails du nouveau contenu</p>
        </div>
      </div>
    </div>
    
    <!-- Form -->
    <form action="{{ route('contenus.store') }}" method="POST" class="needs-validation" novalidate>
      @csrf
      <div class="p-6 space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="space-y-6">
            ...
            <div>
              <label for="titre" class="block text-sm font-medium text-gray-700 mb-1 flex items-center">
                ...
                Titre du contenu <span class="text-red-500 ml-1">*</span>
              </label>
              <div class="relative">
            ...
            <div>
              <label for="date_creation" class="block text-sm font-medium text-gray-700 mb-1 flex items-center">
                ...
                Date de création <span class="text-red-500 ml-1">*</span>
              </label>
              <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Utilisateur -->
            <div>
              <label for="id_utilisateur" class="block text-sm font-medium text-gray-700 mb-1 flex items-center">
                <svg class="w-4 h-4 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="space-y-6">
            <!-- Type de contenu -->
            <div>
              <label for="type_contenu_id" class="block text-sm font-medium text-gray-700 mb-1 flex items-center">
                <svg class="w-4 h-4 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div class="relative">
                ...
                <select
                  id="type_contenu_id"
                  name="type_contenu_id"
                  class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 appearance-none bg-white"
                >
                  <option value="">Sélectionnez un type</option>
                  @foreach($type_contenus as $type_contenu)
                    <option value="{{ $type_contenu->id }}" {{ old('type_contenu_id') == $type_contenu->id ? 'selected' : '' }}>
                      {{ $type_contenu->nom_contenu }}
                    </option>
                  @endforeach
                </select>
              </div>
        ...
        <div>
          <label for="texte" class="block text-sm font-medium text-gray-700 mb-1 flex items-center">
            ...
            Contenu texte <span class="text-red-500 ml-1">*</span>
          </label>
          <div class="relative">
            ...
            <textarea
              ...
              rows="6"
              class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
              placeholder="Rédigez le contenu de votre texte..."
              required
            >{{ old('texte') }}</textarea>
          </div>
          <div class="text-xs text-gray-500 mt-1 flex items-center">
  ...
  <div class="bg-white shadow-md rounded-lg overflow-hidden border border-gray-200 mt-6">
    <div class="bg-gradient-to-r from-amber-50 to-orange-50 px-6 py-4 border-b border-gray-200">
      <div class="flex items-center">
        ...
        <div>
          <h2 class="text-xl font-semibold text-gray-800">Conseils pour créer un bon contenu</h2>
          <p class="text-sm text-gray-600 mt-1">Bonnes pratiques pour la rédaction de contenu</p>
        </div>
      </div>
    </div>
    <div class="p-6">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="flex items-start">
          ...
          <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Utilisez un titre clair et descriptif</p>
          </div>
        </div>
        <div class="flex items-start">
          <svg class="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Structurez votre texte avec des paragraphes</p>
          </div>
        </div>
        <div class="flex items-start">
          <svg class="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Vérifiez l'orthographe avant de publier</p>
          </div>
        </div>
        <div class="flex items-start">
          <svg class="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div>
            ...
            <p class="text-sm text-gray-600 mt-1">Choisissez le statut approprié pour votre contenu</p>
          </div>
        </div>
      </div>
    </div>
