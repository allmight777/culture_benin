...
<div class="flex justify-between items-center mb-6">
    <div>
        ...
        <p class="text-gray-600 mt-1">Gestion des régions et territoires</p>
    </div>
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="flex items-center space-x-2">
            ...
            <li>
                <span class="text-gray-500 font-medium">Régions</span>
            </li>
        </ol>
    </nav>
</div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 space-y-4 sm:space-y-0">
            <div>
                ...
                <p class="text-gray-600 mt-2">Liste de toutes les régions et territoires</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-200 p-6 transform hover:scale-105 transition-transform duration-300">
                ...
                <div class="space-y-4">
                    <div class="flex justify-between items-center p-3 bg-primary-50 rounded-lg">
                        <span class="text-sm font-medium text-gray-700">Total des régions:</span>
                        <span class="font-bold text-primary-600 text-lg">{{ $regions->count() }}</span>
                    </div>
                    <div class="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                        <span class="text-sm font-medium text-gray-700">Population totale:</span>
                        <span class="text-sm font-semibold text-green-600">
                            {{ number_format($regions->sum('population'), 0, ',', ' ') }} hab.
                        </span>
                    </div>
                </div>
            </div>
                    ...
                    <a href="{{ route('regions.create') }}" 
                       class="flex items-center justify-between p-3 bg-gradient-to-r from-primary-50 to-blue-50 rounded-lg hover:from-primary-100 hover:to-blue-100 transition-all duration-200 group">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm font-medium text-gray-700 group-hover:text-gray-900">Ajouter une région</span>
                        </div>
            ...
            <div class="bg-gradient-to-br from-white to-gray-50 rounded-2xl border border-gray-200 p-6 transform hover:scale-105 transition-transform duration-300">
                ...
                <p class="text-sm text-gray-600 mb-4 leading-relaxed">
                    Gérez facilement vos régions avec les actions disponibles. Utilisez les boutons pour voir, modifier ou supprimer les régions.
                </p>
                    ...
                    <table id="regionsTable" class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                                    <div class="flex items-center">
                                        <i class="fas fa-location-arrow mr-2 text-primary-500"></i>
                                        Localisation
                                    </div>
                                </th>
                                <th class="px-6 py-4 text-left text-xs font-semibold text-gray-700 uppercase tracking-wider">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50 transition-all duration-200 group">
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10 bg-gradient-to-br from-primary-100 to-primary-200 rounded-xl flex items-center justify-center shadow-sm group-hover:shadow-md transition-shadow duration-200">
                                            <i class="fas fa-map text-primary-600"></i>
                                        </div>
                                        <div class="ml-4">
                                            <div class="text-sm font-semibold text-gray-900 group-hover:text-primary-700 transition-colors duration-200">
                                                {{ $region->nom_region }}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900 max-w-xs truncate group-hover:text-gray-700 transition-colors duration-200">
