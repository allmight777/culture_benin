...
<div class="flex justify-between items-center mb-6">
  <h1 class="text-2xl font-bold text-gray-800">Créer une nouvelle région</h1>
    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
      ...
      <li aria-current="page">
        <div class="flex items-center">
          ...
          <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Nouvelle région</span>
        </div>
      </li>
    </ol>
  </nav>
  ...
  <div class="bg-white shadow-md rounded-lg overflow-hidden border border-gray-200">
    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-4 border-b border-gray-200">
      <div class="flex items-center">
        ...
        <div>
          <h2 class="text-xl font-semibold text-gray-800">Informations de la région</h2>
          <p class="text-sm text-gray-600 mt-1">Remplissez les détails de la nouvelle région</p>
        </div>
      </div>
    </div>
      ...
      <div class="p-6 space-y-6">
        ...
        <div>
          ...
          <div class="text-xs text-gray-500 mt-1 flex items-center">
            ...
            Une brève description de la région
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label for="population" class="block text-sm font-medium text-gray-700 mb-1 flex items-center">
              ...
              Population <span class="text-red-500 ml-1">*</span>
            </label>
            <div class="relative">
              <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div>
            <label for="superficie" class="block text-sm font-medium text-gray-700 mb-1 flex items-center">
              ...
              Superficie <span class="text-red-500 ml-1">*</span>
            </label>
            <div class="relative">
              <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <div>
          <label for="localisation" class="block text-sm font-medium text-gray-700 mb-1 flex items-center">
            ...
            Localisation <span class="text-red-500 ml-1">*</span>
          </label>
          <div class="relative">
            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="text-xs text-gray-500 mt-1 flex items-center">
            ...
            Position géographique ou coordonnées
          </div>
        </div>
      </div>
