    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between items-center mb-8">
            <div>
                ...
                <p class="text-gray-600 mt-2">Informations complètes sur la région</p>
            </div>
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                                    <div class="flex items-center mb-3">
                                        ...
                                        <h3 class="text-sm font-semibold text-gray-700 uppercase tracking-wide">Nom de la région</h3>
                                    </div>
                                    <p class="text-xl font-bold text-gray-800 bg-white rounded-lg px-4 py-3 border border-gray-200">
                                        {{ $region->nom_region }}
                                    </p>
                                </div>
                                ...
                                <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                                    ...
                                    <div class="bg-white rounded-lg px-4 py-3 border border-gray-200 min-h-[100px]">
                                ...
                                <div class="bg-gray-50 rounded-xl p-4 border border-gray-200">
                                    <div class="flex items-center mb-3">
                                        <i class="fas fa-location-arrow text-gray-500 mr-2"></i>
                                        <h3 class="text-sm font-semibold text-gray-700 uppercase tracking-wide">Localisation</h3>
                                    </div>
                                    <div class="flex items-center justify-between bg-white rounded-lg px-4 py-3 border border-gray-200">
                                        <span class="text-gray-800">{{ $region->localisation ?? 'Non spécifiée' }}</span>
                                        <button onclick="copyToClipboard('{{ $region->localisation }}')" 
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <!-- Population -->
                                    <div>
                                        <label class="block text-xs font-medium text-gray-500 mb-1">Population</label>
                                        <div class="flex items-center text-gray-800 bg-white border border-gray-200 rounded-lg px-4 py-3">
                                            ...
                                            <span class="text-lg font-bold">{{ number_format($region->population, 0, ',', ' ') }} habitants</span>
                                        </div>
                                    </div>

                                    <!-- Superficie -->
                                    <div>
                                        <label class="block text-xs font-medium text-gray-500 mb-1">Superficie</label>
                                        <div class="flex items-center text-gray-800 bg-white border border-gray-200 rounded-lg px-4 py-3">
                                            <i class="fas fa-ruler-combined text-primary-500 mr-3"></i>
                                            <span class="text-lg font-bold">{{ number_format($region->superficie, 0, ',', ' ') }} km²</span>
                                        </div>
                                    </div>

                                    <!-- Densité de population -->
                                    <div>
                                        <label class="block text-xs font-medium text-gray-500 mb-1">Densité de population</label>
                                        <div class="flex items-center text-gray-800 bg-white border border-gray-200 rounded-lg px-4 py-3">
                                            <i class="fas fa-chart-pie text-primary-500 mr-3"></i>
                                            <span class="text-lg font-bold">
                                                @php
                                                    $densite = $region->population && $region->superficie ? round($region->population / $region->superficie, 2) : 0;
                                                @endphp
                                                {{ $densite }} hab/km²
                                            </span>
                                        </div>
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center text-gray-800 bg-white border border-gray-200 rounded-lg px-4 py-3">
                                            ...
                                            {{ \Carbon\Carbon::parse($region->created_at)->format('d/m/Y à H:i') }}
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-center text-gray-800 bg-white border border-gray-200 rounded-lg px-4 py-3">
                                            ...
                                            {{ \Carbon\Carbon::parse($region->updated_at)->format('d/m/Y à H:i') }}
                                            <span class="ml-2 text-sm text-gray-500">
                                                (il y a {{ \Carbon\Carbon::parse($region->updated_at)->diffForHumans() }})
                                            </span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="mt-8 pt-6 border-t border-gray-200">
                            <div class="flex flex-wrap gap-3 justify-between items-center">
                                <div class="flex items-center text-sm text-gray-500">
                                    ...
                                    Région créée le {{ \Carbon\Carbon::parse($region->created_at)->format('d/m/Y à H:i') }}
                                </div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 h-fit">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center p-3 bg-blue-50 rounded-lg">
                            <span class="text-sm font-medium text-gray-700">Population:</span>
                            <span class="font-bold text-blue-600">{{ number_format($region->population, 0, ',', ' ') }}</span>
                        </div>
                        <div class="flex justify-between items-center p-3 bg-green-50 rounded-lg">
                            <span class="text-sm font-medium text-gray-700">Superficie:</span>
                            <span class="font-bold text-green-600">{{ number_format($region->superficie, 0, ',', ' ') }} km²</span>
                        </div>
                        <div class="flex justify-between items-center p-3 bg-purple-50 rounded-lg">
                            <span class="text-sm font-medium text-gray-700">Densité:</span>
                        ...
                        <div class="flex justify-between items-center p-3 bg-amber-50 rounded-lg">
                            <span class="text-sm font-medium text-gray-700">Ratio hab/km²:</span>
                            <span class="font-bold text-amber-600">
                                @php
                                    $ratio = $region->superficie ? round($region->population / $region->superficie, 1) : 0;
                                @endphp
                                1:{{ $ratio }}
                            </span>
                        </div>
                        ...
                        <a href="{{ route('regions.edit', $region->id) }}" 
                           class="flex items-center justify-between p-3 bg-amber-50 rounded-lg hover:bg-amber-100 transition-colors group">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-medium text-gray-700">Modifier cette région</span>
                            </div>
                        ...
                        <a href="{{ route('regions.create') }}" 
                           class="flex items-center justify-between p-3 bg-green-50 rounded-lg hover:bg-green-100 transition-colors group">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-medium text-gray-700">Ajouter une région</span>
                            </div>
                            <i class="fas fa-chevron-right text-gray-400 group-hover:text-green-500"></i>
                        </a>

                        <button onclick="copyToClipboard('{{ $region->nom_region }}')" 
                            ...
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-medium text-gray-700">Copier le nom</span>
                            </div>
                        ...
                        <a href="{{ route('regions.index') }}" 
                           class="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors group">
                            <div class="flex items-center">
                                ...
                                <span class="text-sm font-medium text-gray-700">Voir toutes les régions</span>
                            </div>
