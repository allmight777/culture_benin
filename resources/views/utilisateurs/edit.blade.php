    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
      ...
      <li aria-current="page">
        <div class="flex items-center">
          ...
          <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Modifier l'utilisateur</span>
        </div>
      </li>
    </ol>
  </nav>
...
<div class="max-w-6xl mx-auto">
  <div class="bg-white shadow-md rounded-lg overflow-hidden border border-gray-200">
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          ...
          <div>
            ...
            <p class="text-sm text-gray-600 mt-1">ID: {{ $utilisateur->id }} - {{ $utilisateur->prenom }} {{ $utilisateur->nom }}</p>
          </div>
        </div>
    ...
    <!-- Form -->
    <form action="{{ route('utilisateurs.update', $utilisateur->id) }}" method="POST" class="needs-validation" novalidate>
      @csrf
      @method('PUT')
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input
                  ...
                  value="{{ old('date_inscription', \Carbon\Carbon::parse($utilisateur->date_inscription)->format('Y-m-d')) }}"
                  class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200"
                />
              </div>
            ...
            <div>
              ...
              <div class="relative">
                ...
                <select
                  ...
                  class="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200 appearance-none bg-white"
                >
                  <option value="Utilisateur" {{ old('statut', $utilisateur->statut) == 'Utilisateur' ? 'selected' : '' }}>Utilisateur</option>
                  <option value="Modérateur" {{ old('statut', $utilisateur->statut) == 'Modérateur' ? 'selected' : '' }}>Modérateur</option>
                  <option value="Administrateur" {{ old('statut', $utilisateur->statut) == 'Administrateur' ? 'selected' : '' }}>Administrateur</option>
                  <option value="Éditeur" {{ old('statut', $utilisateur->statut) == 'Éditeur' ? 'selected' : '' }}>Éditeur</option>
                </select>
              </div>
              @error('statut')
                <p class="text-red-500 text-sm mt-1 flex items-center">
